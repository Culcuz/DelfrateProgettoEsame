                    ...
                    <div class="row">
                        <form action="./insProdotto.php" method="post">
                                    ...
                                    <div class="card-header card-header-tabs card-header-spedizione">
                                        <div class="nav-tabs-navigation">
                                            <div class="nav-tabs-wrapper">
                                                <h4 class="card-title">Spedizione</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-header card-header-tabs card-header-fatturazione">
                                        <div class="nav-tabs-navigation">
                                            <div class="nav-tabs-wrapper">
                                                <h4 class="card-title">Fatturazione</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="summary col-md-4">
                                <div class="terms">
                                    <h4 class="headline-primary">Fattura e spedisci assieme </h3>
                                        
                                    <button type="button" class="btn" style="background-color: #ff0000;">Fattura e spedisci assieme</button>
                                </div>
                            </div>
